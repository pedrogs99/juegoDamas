...
void joc()
{
	...
	do //se ejecuta el bucle constantemente esperando acontecimientos(clicks) o ESC
	{
		...
		P.acabaPartida();//revisa si alguien gana la partida (si no queda ninguna ficha de alguno de los colores), y si es asi, muestra la pantalla de victoria
						//de negras o blancas segun corresponda y el sonido
